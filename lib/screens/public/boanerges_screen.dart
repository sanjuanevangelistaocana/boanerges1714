          ...
          Padding(
            ...
            child: Center(
              child: ConstrainedBox(
                ...
                child: StreamBuilder<List<Revista>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return _RevistaCard(revista: revista, isWide: isWide);
                      },
                    );
                  },
                ),
    ...
    return Card(
      ...
      child: InkWell(
        onTap: revista.pdfUrl.isNotEmpty
            ? () => launchUrl(Uri.parse(revista.pdfUrl), mode: LaunchMode.externalApplication)
            : null,
        borderRadius: BorderRadius.circular(12),
        child: isWide
            ? Column(
                ...
                children: [
                  Container(
                    ...
                    child: revista.portadaUrl.isNotEmpty
                        ? ClipRRect(
                            borderRadius: const BorderRadius.vertical(top: Radius.circular(12)),
                            child: Image.network(revista.portadaUrl, fit: BoxFit.cover),
                          )
                        : const Center(child: Icon(Icons.menu_book, size: 48, color: AppTheme.primaryColor)),
                  ),
                  Padding(
            ...
            : ListTile(
                ...
                trailing: const Icon(Icons.picture_as_pdf, color: AppTheme.primaryColor),
              ),
      ),
    );
  }
